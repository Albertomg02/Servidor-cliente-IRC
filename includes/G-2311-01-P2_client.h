/**
 * @brief: Funciones del módulo client
 * @file G-2311-01-P2_client.h
 * @author Oscar Garcia de Lara Parreño & Santiago Gomez Aguirre. Grupo: 2311
 * @date 07-05-2017
 */
#ifndef __G_2311_01_P2_CLIENT_H
#define __G_2311_01_P2_CLIENT_H
...
long IRCInterface_Connect(char *nick, char *user, char *realname, char *password, char *server, int port, boolean ssl);
/**
 * Funcion que se queda escuchando al servidor
 * @method launch_read
 * @param  s  parametro donde se le pasa el valor del socket
 */
...
/**
 * Función que envía el archivo que se quiere transmitir.
 * @method launch_file
 * @param pr        Estructura que guarda la información necesaria para el envío
 */
